...
3. Add an index map and specific class metric logging
4. Add the regression head for pith prediction
5. ~~Ensure metrics logging to MlFlow~~
6. Create a new dataset based on lates changes in the document (less classes)
